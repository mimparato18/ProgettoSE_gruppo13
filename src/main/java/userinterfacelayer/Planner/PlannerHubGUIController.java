...
public class PlannerHubGUIController implements Initializable {
    ...
    private void btnActivity_OnAction(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("ManageActivityGUI.fxml"));
    ...
    private void btnAssign_OnAction(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("AssignActivityGUI.fxml"));
