...
public class ProcedureManagementGUIController implements Initializable {
    ...
    public void btnModify_OnAction(ActionEvent ev) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("ModifyProcedureWindow.fxml"));
    ...
    private void btnAddProced_OnAction(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("CreateProcedureWindow.fxml"));
