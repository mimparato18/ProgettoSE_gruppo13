...
public class TypologyManagementGUIController implements Initializable {
    ...
    public void initializeTable() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            data.add(new DisplayTypology(list.get(i), btnDel[i], btnMod[i]));
    ...
    public void btnModify_OnAction(ActionEvent ev) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("ModifyTypologyWindow.fxml"));
    ...
    private void btnAddTypo_OnAction(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("CreateTypologyWindow.fxml"));
