...
public class SystemAdministratorGUIController implements Initializable {
    ...
    public void btnModify_OnAction(ActionEvent ev) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("ModifyPasswordWindow.fxml"));
    ...
    private void createUser_OnAction(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("CreateUserWindow.fxml"));
